...
class SecurityController extends Controller
{
    public function loginAction()
    {
        ...
        return $this->render('@MProdLicenciaCyP/Security/login.html.twig',
    ...
    {
        return $this->render('@MProdLicenciaCyP/Security/loginCheck.html.twig', array(
                // ...
            ));    }
        ...
        if ($form->isValid()  and $form->isSubmitted()) {
            ...
            try {
                ...
                $message = \Swift_Message::newInstance()->setSubject('Contacto de reporte.')
                    ...
                    ->setBody($this->renderView('@MProdLicenciaCyP/Security/Security/ChangePass.txt.twig'));
            ...
            return $this->render('@MProdLicenciaCyP/Security/changePassword.html.twig', array(
